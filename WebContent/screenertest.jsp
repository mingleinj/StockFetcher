...
<table border="0" cellspacing="5" cellpadding="0">
	<tr>
		...
		<td width=200><label for="amount"></label><div id="sr1"></div></td>
	...
	<tr>
		...
		<td width=200><label for="amount"></label><div id="sr2"></div></td>
	...
	<tr>
		...
		<td width=200><label for="amount"></label><div id="sr3"></div></td>
	...
	<tr>
		...
		<td width=200><label for="amount"></label><div id="sr4"></div></td>
	...
	<tr>
		...
		<td width=200><label for="amount"></label><div id="sr5"></div></td>
